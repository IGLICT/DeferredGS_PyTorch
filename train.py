...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint):
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        gt_alpha_mask_cuda = viewpoint_cam.gt_alpha_mask.cuda()
        ...
        mask_loss = opt.lambda_mask * l1_loss(render_pkg["rend_alpha"][0:1, :, :], gt_alpha_mask_cuda)
        
        # loss
        # total_loss = loss + dist_loss + normal_loss + mask_loss

        total_loss = loss + dist_loss + mask_loss + normal_loss
        total_loss.backward()
        # total_loss.backward()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1000, 5_000, 10000, 20000, 30000])
